  ...
  return (
    <div id='contact' className='w-full lg:h-screen'>
      <div className='max-w-[1240px] m-auto px-2 py-16 w-full '>
        ...
        <h2 className='py-4'>A un solo toque</h2>
        <div className='grid lg:grid-cols-5 gap-8'>
          ...
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
            <div className='lg:p-4 h-full '>
              ...
              <div>
                <h2 className='py-2'>John Bernal</h2>
                <p>Desarrollador</p>
                <p className='py-4'>
                  Estoy disponible para freelance o puestos de tiempo completo. Contáctame y hablemos.
                </p>
              </div>
              <div>
                <p className='uppercase pt-8'>Conectemos</p>
          ...
          <div className='col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4'>
            <div className='p-4'>
              <form action="https://formsubmit.co/johnbernalsierra@gmail.com" method="POST">
